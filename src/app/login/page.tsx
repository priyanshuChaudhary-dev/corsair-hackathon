    ...
    <main className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-slate-100">
      <div className="mx-auto flex w-full max-w-md flex-col gap-8 px-6 py-16">
        <div className="space-y-3 text-center">
          ...
          <h1 className="text-4xl font-semibold text-white">Login to Inbox Orbit</h1>
          <p className="text-sm text-slate-400">Access your Gmail and Calendar workspace with your account.</p>
        </div>
